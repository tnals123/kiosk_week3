...
class Change_myId_Fragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        ...
        var okbutton = myview.findViewById<Button>(R.id.sksmsahffkd)
        ...
        myseq =  (activity as Login_Page).return_seq()
        ...
        okbutton.setOnClickListener(){
            ...
            else if (id.text.toString() != idcheck.text.toString()){
                Toast.makeText(activity, R.string.resister_failed , Toast.LENGTH_SHORT).show()
            }
            else{
                (activity as Login_Page).change_Id(id.text.toString(),myseq)
            }
        }
